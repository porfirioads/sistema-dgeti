...
@section('sidebar_options')
    @include('docente_atp.sidebar_items', ['url' =>
    '../landing_directores', 'texto' => 'Volver a menú de directores'])
@endsection

@section('box_title', 'Docentes ATP')
@section('box_body')
    ...
    <div class="col-lg-offset-11">
        <button class="btn btn-block btn-warning button-float-righ"
                onclick="location.href='{{ url('docente_atp/create') }}'">
                ...
                <td class="row">
                    <div class="col-md-4">
                        <a class="btn btn-block btn-success"
                           href="docente_atp/{{$docente->id}}">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a class="btn btn-block btn-primary"
                           href="docente_atp/{{$docente->id}}/edit">
