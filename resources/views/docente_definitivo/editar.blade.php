    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group col-md-4">
                ...
                $value = $data->primer_apellido,['class' => 'form-control',
            ...
            <div class="form-group col-md-4">
                ...
                $value = $data->segundo_apellido,['class' => 'form-control',
            ...
            <div class="form-group col-md-4">
                ...
                {!! Form::text('correo', $value = $data->correo,['class' =>
            ...
            <div class="form-group col-md-4">
                ...
                $value = $data->telefono_celular,['class' => 'form-control',
            ...
            <div class="form-group col-md-4">
                ...
                $value = $data->telefono_domicilio,['class' => 'form-control',
            ...
            <div class="form-group col-md-12">
                ...
                {!! Form::text('domicilio', $value = $data->domicilio,
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="form-group col-md-4">
                ...
                $value = $data->perfil_profesional,['class' => 'form-control',
            ...
            <div class="form-group col-md-4">
                ...
                $value = $data->horas_frente_grupo,['class' => 'form-control',
            ...
            <div class="form-group col-md-4">
                ...
                $value = $data->horas_descarga_academica,
                ['class' => 'form-control',
            ...
            <div class="form-group col-md-4">
                ...
                {!! Form::text('horas_administrativas',
                 $value = $data->horas_administrativas,
                 ['class' => 'form-control',
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group col-md-12">
                ...
                $value = $data->tipo_plaza_docente->tipo_plaza_horas,
                ['class' => 'form-control', 'placeholder' => 'Tipo Plaza',])!!}
            </div>
            <div class="form-group col-md-12">
