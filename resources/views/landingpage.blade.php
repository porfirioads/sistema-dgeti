...
<header id="top" class="header">
    <div class="row">
        <div class="text-vertical-center">
            ...
            <br/><br/>
            <h2>DIRECCIÓN GENERAL DE EDUCACIÓN TECNOLÓGICA E INDUSTRIAL</h2>
            <br/><br/>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-2">
            <a class=" btn btn-block btn-primary" href="/dashboard">
...
{{--href="mailto:name@example.com">name@example--}}
{{--.com</a>--}}
{{--</li>--}}
{{--</ul>--}}
{{--<br>--}}
...
{{--<li>--}}
{{--<a href="#"><i--}}
{{--class="fa fa-facebook fa-fw fa-3x"></i></a>--}}
{{--</li>--}}
{{--<li>--}}
{{--<a href="#"><i--}}
{{--class="fa fa-twitter fa-fw fa-3x"></i></a>--}}
{{--</li>--}}
{{--<li>--}}
{{--<a href="#"><i--}}
{{--class="fa fa-dribbble fa-fw fa-3x"></i></a>--}}
{{--</li>--}}
{{--</ul>--}}
{{--<hr class="small">--}}
