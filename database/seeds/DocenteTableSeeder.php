...
class DocenteTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('DOCENTE')->insert([
            ...
            'nombre' => utf8_encode('Adri�n Homero'),
            ...
            'domicilio' => utf8_encode('Calle Grava #456 Rinc�n del Pedregal II, Gom�z Palacio, Durango')
        ]);
        ...
        DB::table('DOCENTE')->insert([
            ...
            'segundo_apellido' => utf8_encode('Ort�z'),
            'perfil_profesional' => 'Ingeniero Qu�mico',
        ...
        DB::table('DOCENTE')->insert([
            ...
            'segundo_apellido' => utf8_encode('Garc�a'),
        ...
        DB::table('DOCENTE')->insert([
            ...
            'perfil_profesional' => utf8_encode('Licenciado en Gastronom�a'),
        ...
        DB::table('DOCENTE')->insert([
            ...
            'segundo_apellido' => utf8_encode('Hern�ndez'),
            'perfil_profesional' => utf8_encode('Licenciado en Administraci�n'),
            ...
            'domicilio' => utf8_encode('Calle Estable #222 El Cerro, M�rida, Yucat�n')
        ]);
    }
}
