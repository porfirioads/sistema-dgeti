...
class DocenteATPController extends Controller
{
    /**
    ...
    {
        $docentes_apt =DocenteIdoneo::join ('DOCENTE','DOCENTE.id','=','DOCENTE_IDONEO.docente_id')->get();

        return view('docente_atp.lista')->with('docentes',$docentes_apt);
    }
    ...
    public function show($id)
    {
        ...
        #return $data;
        return view('docente_atp.editar')->with('data', $data);
    }
